  ...
  <div class="container-fluid">
	...
	<div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav navbar-right">
		...
		<security:authorize access="hasRole('ADMIN')">
			...
			<span class="caret"></span></a>
          		<ul class="dropdown-menu">
					<li><a href="" onclick="jumpTo('establecimiento/administrator/list.do');">Establecimientos</a></li>
					
				</ul>
			</li>
			
			<li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="#">
			<img class="iconNav" src="images/icons/icon-invitation.png" title="Nuevo Admin"/> 
			<span class="caret"></span></a>
          		<ul class="dropdown-menu">
					<li><a href="" onclick="jumpTo('administrator/register.do');">Crear Administrador</a></li>				
				</ul>
			</li>
		...
		<li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="#">
			<img class="iconNav" src="images/icons/icon-complaint.png" title="Incidencias"/> 
			<span class="caret"></span></a>
				...
				<ul class="dropdown-menu">
						...
						<li><a href="" onclick="jumpTo('incidencia/estudiante/list.do')">Ver Incidencias</a></li>
						
				</ul>
			
			
			<li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="#">
			<img class="iconNav" src="images/icons/icon-invitation.png" title="Invitar"/> 
			<span class="caret"></span></a>
          		<ul class="dropdown-menu">
					<li><a href="" onclick="jumpTo('estudiante/invite.do');">Invitar amigo</a></li>				
		...
		<security:authorize access="isAnonymous()">
			...
			<li class="bigHead"><a style="cursor: pointer;" onclick="clickLogin();">Entrar</a></li>
        	<li class="bigHead"><a href="#users">Usuarios</a></li>
        	<li class="dropdown bigHead"><a class="dropdown-toggle" data-toggle="dropdown" href="#">Idioma<span class="caret"></span></a>
          	<ul class="dropdown-menu">
